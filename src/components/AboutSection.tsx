...
export default function AboutSection() {
  ...
  return (
    <section
      ...
      style={{ background: "#040404", padding: "7rem 0" }}
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse at 25% 55%, rgba(57,255,20,0.06) 0%, transparent 50%)",
        }}
      />
      <div
        className="absolute inset-0 pointer-events-none"
        style={{
          background:
            "radial-gradient(ellipse at 80% 80%, rgba(25,245,165,0.04) 0%, transparent 45%)",
        }}
      />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <motion.div
            ...
            transition={{ duration: 0.88, delay: 0.1 }}
            ...
            >
              ...
              <div
                ...
                style={{
                  inset: "-16px",
                  background:
                    "radial-gradient(ellipse at 50% 85%, rgba(57,255,20,0.12) 0%, transparent 60%)",
                  filter: "blur(24px)",
                }}
              />
              {/* Corner accents */}
              <div
                ...
                style={{
                  ...
                  boxShadow: "-3px -3px 12px rgba(57,255,20,0.3)",
                }}
              />
              <div
                className="absolute"
              ...
              >
                ...
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(to top, rgba(4,4,4,0.7), transparent)",
                  }}
                />
              </div>
            </div>
          ...
          <motion.div
            initial={{ opacity: 0, x: 40 }}
            animate={inView ? { opacity: 1, x: 0 } : {}}
            transition={{ duration: 0.88, delay: 0.26 }}
          >
            <div
              ...
              style={{
                ...
                boxShadow:
                  "0 28px 70px rgba(0,0,0,0.65), inset 0 1px 0 rgba(255,255,255,0.07)",
              }}
            >
              ...
              <div className="absolute -top-5 -right-3 opacity-65">
                <svg width="62" height="62" viewBox="0 0 70 70">
                  <path
                    d="M 60 8 Q 66 32 50 46 Q 34 60 18 54 Q 8 48 13 38 Q 19 28 29 34 Q 34 37 29 44"
                    stroke="#39FF14"
                    strokeWidth="4"
                    fill="none"
                    strokeLinecap="round"
                    opacity="0.55"
                  />
                  <circle cx="29" cy="45" r="5" fill="#39FF14" opacity="0.6" />
                </svg>
              </div>
              ...
              >
                I AM <span className="neon-text">ISAAC</span>
                <span
                  style={{
                    fontSize: "0.75rem",
                    fontWeight: 500,
              ...
              >
                ...
                creating compelling visual narratives for brands, publications,
                churches, and digital platforms. My approach combines strategic
                thinking with artistic vision — ensuring every design not only
                looks beautiful but achieves measurable results. I believe great
                design should tell a story, evoke emotion, and drive action.
              </p>
                ...
                {[1, 0, 0].map((a, i) => (
                  <span
                    ...
                    style={{
                      ...
                      height: 7,
                      borderRadius: "50%",
                      background: a ? "#39FF14" : "rgba(255,255,255,0.16)",
                      display: "inline-block",
                      boxShadow: a ? "0 0 6px rgba(57,255,20,0.6)" : "none",
                    }}
                  />
                ))}
              </div>
